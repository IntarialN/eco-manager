...
- Уровень защищённости ПДн: предполагается 1 или 2 (уточнить у заказчика).
...
- Бэкап БД — ежедневно, хранение ≥ 30 дней, гео-избыточность (минимум 2 площадки).
- Бэкап storage — инкрементальный, раз в 24 часа, хранение ≥ 30 дней.
- Проверка восстановления — раз в месяц (тестовое восстановление).
- План аварийного восстановления (DRP): RTO ≤ 8 часов, RPO ≤ 24 часов.
- TODO: определить конкретные инструменты бэкапа и облачную инфраструктуру.
...
- TODO: согласовать требования по сертификации хранилища (ФСТЭК/ФСБ при необходимости).
...
- TODO: подготовить шаблон уведомления о нарушении ПДн и план взаимодействия с регулятором.
...
- [ ] Уточнены уровни защищённости ПДн, инструменты бэкапа, сертификация (ожидает данных).
