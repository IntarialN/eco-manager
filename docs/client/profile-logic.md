...
- [ ] Синхронизированы интеграции и webhook-и после получения реальных спецификаций.

## Связанные документы и регламент обновлений

- `docs/client/onboarding-form.md` — источник данных.
- `docs/requirements/catalog.md` / `docs/requirements/rules.md` — логика требований на основе анкеты.
- `docs/features/*.md` — функциональные блоки, которые получают данные из профиля.
- `docs/admin/reference-management.md` — справочники, которые могут переопределять вычисления.
- `docs/architecture/integration-plan.md` / `docs/architecture/mock-bubble-api.md` — интеграции, задействованные при профилировании.
- `docs/documentation-todo.md`, `docs/completed/` — статусы и завершённые задачи.

Перед изменением профилирования:
1. Убедиться, что анкета и требования обновлены согласованно.
2. Синхронизировать изменения с функциональными блоками и интеграциями.
3. Зафиксировать результат в TODO/Completed, указав, какие части системы затронуты.
